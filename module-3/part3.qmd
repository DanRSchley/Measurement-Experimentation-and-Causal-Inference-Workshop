...
The practical implication is uncomfortable but important: **the causal precision of an RDD is bounded above by the discriminant validity of its running variable**, in exactly the same way that a scale with poor discriminant validity cannot cleanly estimate the effect of its target construct. A high-quality regression discontinuity study begins with a running variable that demonstrably measures what it claims to measure — and demonstrably does not measure what it claims not to measure.
