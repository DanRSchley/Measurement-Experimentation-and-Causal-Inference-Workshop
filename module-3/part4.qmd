...
<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vSXVhKGWYmdPGDCK7MsNNmequAI9bYAUVNioz9v8w1kJukTxjUmh8kvzXF8mMg1OQ/pub?start=false&loop=false&delayms=3000" width="100%" height="500px" frameborder="0" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" title="Module 3 Part 4: Difference-in-Differences"></iframe>
...
- With **5–6 pre-periods**: Power improves substantially. But violations that slip through the test still produce inflated Type I error. Note that at 5–6 pre-periods, very few of the 300 simulations pass the pre-test (see "Sims passing" in the table) — the conditional Type I estimate rests on a small denominator and should be read cautiously.
