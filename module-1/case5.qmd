...
n_pt  <- 8
adv_pt   <- c(24, 0.5, 2, 22, 1, 23, 3, 21)     # extreme advertising values
sales_pt <- c(-1, 22, -4, 35, 20,  2, 24, -3)   # extreme / inconsistent sales
...
ggplot() +
  ...
  labs(
    ...
    subtitle = "Red dotted = OLS distorted by outliers  |  Blue solid = true DGP (slope 0.40)  |  Green dashed = robust MM"
  ) +
