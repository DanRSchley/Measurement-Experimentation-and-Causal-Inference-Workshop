---
title: "Case 3: Measurement Invariance"
---
...
<iframe src="https://liveeur-my.sharepoint.com/personal/58542dsc_eur_nl/_layouts/15/Doc.aspx?sourcedoc={2a83ad5d-e6e7-4cd7-95bb-833de1799feb}&action=embedview&wdAr=1.7777777777777777" width="100%" height="500px" frameborder="0" allowfullscreen title="Module 1 Part 2: Measurement Invariance"></iframe>
...
```{r case3-semtools-score}
#| code-summary: "▶ semTools: score-test approach to pinpoint non-invariant items"
# semTools::lavTestScore provides score statistics for each equality constraint.
# Constraints with large X² are the ones most responsible for the scalar model
# failing — these are the non-invariant items.
score_test <- semTools::lavTestScore(fit_scalar, cumulative = TRUE)
...
kable(
  ...
  digits    = 3,
  caption   = "semTools Score Tests: Intercept Constraints Ranked by Misfit (Scalar Model, Scenario B)"
)
```
