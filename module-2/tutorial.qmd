...
We now simulate the coffee experiment with a realistic data-generating process. Each participant has ten binary latent characteristics that determine both *what signals they extract from the eco-label* and *how much they are willing to pay*.
...
3. **Identification strategy:** once you have measured mediators, you can decompose the total treatment effect into its component channels via structural models (which we address in detail in Module 3)
