...
# High WTP → quality language; Low WTP → price/budget/overpay language.
# This mimics how real open-ended responses reflect stated amounts.
add_wtp_anchor <- function(i, base_text) {
  w <- WTP_p2[i]
  anchor <- if (w >= 7.5) {
    "Taken together, the quality and overall appeal of this product make it feel genuinely worth it — I am happy to spend considerably above what I normally would."
  } else if (w >= 5.5) {
    "Taken together, I think the value here is reasonable — nothing that excites me, but a fair trade-off between quality and cost."
  } else {
    "Taken together, I am quite price-conscious about this purchase and would not want to overpay — I need to stay within my usual budget for coffee."
  }
